...
<template>
  ...
  >
    <div 
      v-show="ShowNotificatino && status === 'update-cover-image'"
    ...
    >
      <div class="flex items-center justify-between p-4">
        ...
        <CheckCircleIcon  class="w-6 h-6 text-emerald-500 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24" />
  ...
  <div class="h-[150px] sm:h-[200px]">
    <img class="h-full w-full object-cover bg-cover bg-center"
      :src="CoverImgSrc || user.cover_url || '/img/default_cover.jpg'"
      alt="Cover Image">
  </div>
<div class="absolute top-2 right-2"> 
  ...
  <div class="py-2 flex flex-col sm:flex-row items-center sm:items-end px-4 -mt-16 sm:-mt-20">
    <img class="w-24 h-24 sm:w-28 sm:h-28 rounded-full border-4 border-white object-cover"
