...
import GroupList from '@/Components/app/GroupList.vue'; // Adjust the path as necessary
import FollowingList from '@/Components/app/FollowingList.vue'; // Adjust the path as necessary
